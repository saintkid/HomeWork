...
public class GameDao {
    ...
    //SaveGame manager
    public void selectSaveGame(String name,  String gameName){

        Log.d("TestSaveGame","selectSaveGame");
        BmobQuery<SaveGame> query = new BmobQuery<>();
        query.addWhereEqualTo("gameName", gameName);
        query.addWhereEqualTo("name",name);
    ...
    public boolean saveGame(String name,int type, ArrayList<Point> points, String gameName, int time){
        isSave = true;
